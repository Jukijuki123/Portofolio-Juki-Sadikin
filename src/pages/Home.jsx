...
export default function Hero() {
  ...
  return (
    <section id="home" className="min-h-screen flex items-center pt-24 overflow-hidden">
      {/* PERBAIKAN: Jarak gap diubah menjadi responsif */}
      <div className="max-w-6xl mx-auto px-6 flex flex-col-reverse md:flex-row gap-8 md:gap-12 items-center justify-between">

        <motion.div
          initial={{ opacity: 0, x: -40 }}
          animate={{ opacity: 1, x: 0 }}
          transition={{ duration: 0.7 }}
          className="w-full md:w-auto" // Memastikan lebar kontainer teks penuh
        >
          ...
          <p className="mt-6 text-gray-600 leading-relaxed max-w-lg text-base md:text-lg">
            {t("hero.description")}
          </p>
          ...
          <div className="flex flex-wrap gap-4 mt-8">
            ...
            <a
              href="/cv-juki-sadikin.pdf"
              download="CV_Juki_Sadikin.pdf"
              aria-label="Unduh Resume"
              className="px-6 py-3 border border-primary rounded-xl hover:bg-teal-50 text-primary focus:ring-4 focus:ring-primary/30 outline-none transition flex items-center justify-center"
            >
              {t("hero.ctaResume")}
            </a>
          </div>
