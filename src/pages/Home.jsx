...
return (
  ...
  >
    <div className="max-w-6xl mx-auto px-6 flex flex-col-reverse md:flex-row gap-12 items-center justify-between">
      ...
      >
        ...
        <div className="flex flex-wrap gap-4 mt-8">
          ...
          <button
            ...
            className="px-6 py-3 border border-primary rounded-xl hover:bg-teal-50 text-primary focus:ring-4 focus:ring-primary/30 outline-none transition"
          >
            {t("hero.ctaContact")}
          </button>
        </div>
